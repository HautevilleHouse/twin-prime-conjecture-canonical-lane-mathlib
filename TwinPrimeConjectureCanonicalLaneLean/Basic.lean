/-!
# twin-prime-conjecture-canonical-lane Lean migration boundary
...
`TwinPrimeConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "twin-prime-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/twin-prime-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Twin Prime Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["analytic-number-theory", "mathematical-proof", "number-theory", "prime-gaps", "reproducibility", "twin-prime-conjecture", "sieve-methods", "canonical-lane", "local-to-global", "manifold-constrained"]
